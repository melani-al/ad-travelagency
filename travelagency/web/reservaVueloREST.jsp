...
<html>
    <head>
        ...
        <title>Reserva plazas Vuelo REST</title>
         <style>
            ul {
    ...
    <body>
        ...
        <h2>Reserva plazas libres: </h2>
        <form action="/RestAD/webresources/generic/reserva_plaza" method="post">
            Identificador del hotel:<br>
            <input type="text" name="id_vuelo"/><br><br>
            Fecha (YYYYMMDD):<br>
