...
@WebServlet(urlPatterns = {"/ConsultaHotelSOAP"})
public class ConsultaHotelSOAP extends HttpServlet {
...
"        </ul>");
        ...
        free = freeRooms(idH, date);
        out.println("<h2>Habitaciones libres para el hotel " + request.getParameter("id_hotel") +": </h2>");
